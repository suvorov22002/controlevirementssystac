...
/**
 * Entity implementation class for Entity: Fichiers Comptabilisation Aller
 * Classe pour l'entité Doublons
 * //@author Stéphane Mouafo
 *
 */
//@Entity
//@Table(name = "VIR_SYSTAC_FICH_COMPTA_ALLER")
public class FichiersComptabilisationAller implements Serializable{
	...
	//@OneToMany(mappedBy = "fichiersComptabilisationAller", cascade = {CascadeType.ALL})
