...
public class StatistiquesRapportsDialog extends AbstractDialog {

	private StatistiqueRapports currentObject = new StatistiqueRapports();
	...
	private List<StatistiqueRapports> listStatRapports = new ArrayList<StatistiqueRapports>();
	 ...
	 */
	public StatistiquesRapportsDialog() {
		super();
	}
	 ...
	 */
	public StatistiquesRapportsDialog(DialogFormMode mode, StatistiqueRapports traitementTourCompensation, IViewComponent parent) {
	...
	public String getFileDefinition() {
		// TODO Auto-generated method stub
		return "/views/virementsRec/StatistiquesRapportsDialog.xhtml";
	}

	@SuppressWarnings("unchecked")
	@Override
	public StatistiqueRapports getCurrentObject() {
		// TODO Auto-generated method stub
	...
	public void processRecherche(){
		if(dateDebut!=null && dateFin!=null){
			listStatRapports = ViewHelper.virementsRecManagerDAOLocal.filter(StatistiqueRapports.class, null, RestrictionsContainer.getInstance().add(Restrictions.between("dateRapport", dateDebut, dateFin)), OrderContainer.getInstance().add(Order.desc("dateRapport")), null, 0, -1);
		}
		else{
			this.error = true;
	...
	public void setCurrentObject(StatistiqueRapports currentObject) {
	...
	public List<StatistiqueRapports> getListStatRapports() {
		return listStatRapports;
	}

	public void setListStatRapports(List<StatistiqueRapports> listStatRapports) {
		this.listStatRapports = listStatRapports;
	}
