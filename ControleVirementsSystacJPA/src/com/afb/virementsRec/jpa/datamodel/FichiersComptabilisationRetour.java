...
/**
 * Entity implementation class for Entity: Fichiers Comptabilisation Retour
 * Classe pour l'entité Doublons
 * //@author Stéphane Mouafo
 *
 */
//@Entity
//@Table(name = "VIR_SYSTAC_FICH_COMPTA_RETOUR")
public class FichiersComptabilisationRetour implements Serializable{
	...
	//@OneToMany(mappedBy = "fichiersComptabilisationRetour", cascade = {CascadeType.ALL})
